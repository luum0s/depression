...
if __name__ == "__main__":
    ...
    train_data = pickle.load(open('dd_data/dailydialog_train.pkl', 'rb'), encoding='latin1')
    dev_data = pickle.load(open('dd_data/dailydialog_dev.pkl', 'rb'), encoding='latin1')
    test_data = pickle.load(open('dd_data/dailydialog_test.pkl', 'rb'), encoding='latin1')
    ...
    pickle.dump(train_knowledge, open('dd_data/dailydialog_train_know.pkl', 'wb'))
    pickle.dump(dev_knowledge, open('dd_data/dailydialog_dev_know.pkl', 'wb'))
    pickle.dump(test_knowledge, open('dd_data/dailydialog_test_know.pkl', 'wb'))
