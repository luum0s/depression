...
from utils_pretrain0 import (convert_examples_to_features,
...
args = {
    'data_dir': '/code/codes/TMLM pretraining/data/',
    'model_type':  'bert',#'albert'
    #'model_name': 'albert-large-v2',#统一变成小写#'bert-base-uncased'
    'model_name': '/models/bert_base_uncased',#保留原始大写字母
    'task_name': 'binary',
    'output_dir': '/results/outputs_pretrain',
    'cache_dir': 'cache/',
    'do_train': True,
    'do_eval': True,
...
#############PubMedBERT#############
##PubMedBERT
config = AutoConfig.from_pretrained("microsoft/BiomedNLP-PubMedBERT-base-uncased-abstract-fulltext", output_hidden_states=True)
tokenizer = AutoTokenizer.from_pretrained("microsoft/BiomedNLP-PubMedBERT-base-uncased-abstract-fulltext")
model = BertForMaskedLM.from_pretrained("microsoft/BiomedNLP-PubMedBERT-base-uncased-abstract-fulltext",config=config)
'''
